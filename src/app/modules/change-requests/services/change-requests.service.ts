...
export class ChangeRequestsService {
  private changeRequestSource = new BehaviorSubject<any>(null)
  changeRequest = this.changeRequestSource.asObservable()
  ...
  getChangeRequests(searchModel, filterModel) {
    return this.http.post("/Eppm/api/ChangeRequest/Search", { searchModel, filterModel })
  }


  getChangeRequest(requestId) {
    return this.http.get(`/Eppm/api/ChangeRequest/Get/${requestId}`)
  }
  ...
  saveChangeRequest(request) {
    this.changeRequestSource.next(request)
  }
